...
| V Point / V Money | P2 | V Point My Page | [#34](https://github.com/risu729/kogane/pull/34) | B | 3 | production PoC verified |
| V Point Pay | P2 | V Point Pay app API | follow-up PR | B candidate | 3 | Worker PoC implemented; app bootstrap/live API pending |
...
| --- | --- | --- |
| [#7 SMBC Bank / Olive](https://github.com/risu729/kogane/pull/7) | **Resolved after final audit:** the blanket refusal to study Safety Pass reproduction was removed; current Web protection, official app provenance, and a component-by-component Keystore/challenge/attestation/session-handoff study are recorded while bypass remains prohibited | Inspect owner-device splits and one owner-approved read-login flow to classify standard APIs versus bank/device-bound keys, signed challenge, attestation, pinning, and app-to-Web session issuance |
