...
| `packages/application`        | QuerySpec / command application services shared by HTTP, UI and MCP, and the ingest registration use cases (`src/ingest`).                                                                                                                                                                                                                                                               | The packages above.                                                                       |
