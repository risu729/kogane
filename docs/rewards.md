...
- `services/observation-pipeline/test/reward-read-projection.test.ts` — 実D1でのlane。flag offで
...
- `services/evidence-browser/test/rewards-v2-read.test.ts` — routeの503・cursor・再現可否・
