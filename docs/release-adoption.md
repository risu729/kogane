...
| Release                | Behaviour                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `legacy-metadata-v1`   | The pre-A04 `hydrateMeta`, plus the MyJCB shared-manifest lookup for inputs it refused ([ADR 0025](adr/0025-myjcb-shared-manifest-metadata.md)): a stored MyJCB value wins over the manifest, the Sony Bank wallet-history media type is verified on every run, `observation_artifact_metadata` still receives the same `INSERT OR IGNORE`. Records its projection with `input_digest = 'unknown'`. The default for every dataset without an `active_releases` row. |
