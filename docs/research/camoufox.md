...
| Live resources                | None. No Worker, Container application, registry image, bucket or cron ever existed for it, and the local Docker image was deleted (`poc/CLEANUP-2026-08-26.md`). |
