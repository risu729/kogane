...
| Identity eligibility         | Not part of this package. `services/evidence-browser/src/identity-api.ts` and `observation-organization.ts` read `eligible_identity_runs` (migration 0020) and the publication projection.                                                                                                                                                                                                                                                     | Moved onto `published_parse_runs` in PR-05; a later PR may move them behind the reader.                                                                                                                          |
