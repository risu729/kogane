...
| U16 — the reward lane end to end on real D1, and its total loss (G2-19, G2-20, G0-09)                                          | `services/observation-pipeline/test/reward-read-projection.test.ts` |
| U16 — the reward routes: the published instant, the replay states, the cursor rules                                            | `services/evidence-browser/test/rewards-v2-read.test.ts`            |
