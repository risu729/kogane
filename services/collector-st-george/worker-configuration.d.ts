/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7076e0b39981876f802a19f3766784ca)
// Runtime types generated with workerd@1.20260831.1 2026-09-07 nodejs_compat
interface __BaseEnv_Env {
	DATA: R2Bucket;
	TAMIA: Fetcher;
	COLLECTOR_SCHEMA_VERSION: "st-george-browser-v1";
	EGRESS_MODE: "tamia";
	RELAY_PUBLIC_URL: "wss://kogane-st-george-collector.takuanimal.workers.dev/tcp";
	COLLECTOR_CONTAINER: DurableObjectNamespace<import("./src/worker").StGeorgeCollectorContainer>;
	SESSION_STATE: DurableObjectNamespace<import("./src/worker").StGeorgeCollectionState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "StGeorgeCollectorContainer" | "StGeorgeCollectionState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COLLECTOR_SCHEMA_VERSION" | "EGRESS_MODE" | "RELAY_PUBLIC_URL">> {}
}
