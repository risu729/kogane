...
/** The artifact roles the central descriptors already use for this source. */
export const PROVIDER_CAPTURE_ROLE = "sanitized_provider_capture";
export const COLLECTOR_DERIVED_ROLE = "collector_derived";
/**
 * The collector's own run manifest. It was declared `collector_derived` until
 * ADR 0021, which the Processor refuses (`artifact_lineage_unstated`): the
 * manifest is generated by the collector, not derived from provider bytes.
 */
