...
for client_id in collector-r2-sbi collector-r2-sbi-vc collector-r2-sony-bank collector-r2-sbi-shinsei collector-r2-mobile-suica collector-r2-global-pass collector-r2-myjcb collector-r2-moneyforward collector-r2-v-point collector-r2-vpass collector-r2-v-point-pay-email; do
  (
    cd -- "${raw_dir}"
...
unset key_map sbi_secret sbi_vc_secret sony_secret sbi_shinsei_secret mobile_suica_secret global_pass_secret global_pass_empty_secret myjcb_secret moneyforward_secret vpoint_secret vpass_secret vpoint_pay_email_secret fingerprint_secret
