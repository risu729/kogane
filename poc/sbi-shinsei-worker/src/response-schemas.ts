...
export function validateKnownResponse(
  ...
  switch (schema) {
    ...
    case "unknown":
      throw unknown("No validator is registered for this response");
  }
}
...
function unknown(message: string): UnknownResponseShapeError {
  return new UnknownResponseShapeError(message);
}
