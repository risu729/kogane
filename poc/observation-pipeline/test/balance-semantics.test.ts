...
test("source audit separates explicit deposits, gross totals, rewards, limits and unsupported sources", () => {
  const cases = [
    ...
    ["v-point", "v-point-balance-info", "available_point_bucket", "other"],
    ["v-point", "v-point-smfg-point", "displayed_point_balance", "aggregate"],
    ["v-point-pay", "v-point-pay-notification-event", "prepaid_balance_after_event", "other"],
