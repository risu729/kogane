// Compatibility re-export. src/parsers/sbi-shinsei-yen-deposit-account.ts moved to packages/parsers (design review D07,
...
export * from "../../../../packages/parsers/src/parsers/sbi-shinsei-yen-deposit-account.ts";
