// Compatibility re-export. src/parsers/sbi-foreign-cash-positions.ts moved to packages/parsers (design review D07,
...
export * from "../../../../packages/parsers/src/parsers/sbi-foreign-cash-positions.ts";
