// Compatibility re-export. src/parsers/moneyforward-parser.ts moved to packages/parsers (design review D07,
...
export * from "../../../../packages/parsers/src/parsers/moneyforward-parser.ts";
