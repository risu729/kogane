// Compatibility re-export. shared/organization-contract.ts moved to packages/observation-shared (design review D07,
...
export * from "../../../packages/observation-shared/src/organization-contract.ts";
