// Compatibility re-export. shared/evidence-validation.ts moved to packages/observation-shared (design review D07,
...
export * from "../../../packages/observation-shared/src/evidence-validation.ts";
