// Compatibility re-export. shared/api-schema.ts moved to packages/observation-shared (design review D07,
...
export * from "../../../packages/observation-shared/src/api-schema.ts";
