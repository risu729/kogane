// Compatibility re-export. shared/financial-products.ts moved to packages/observation-shared (design review D07,
...
export * from "../../../packages/observation-shared/src/financial-products.ts";
