// Compatibility re-export. shared/activity-semantics.ts moved to packages/observation-shared (design review D07,
...
export * from "../../../packages/observation-shared/src/activity-semantics.ts";
