// Compatibility re-export. shared/identity-contract.ts moved to packages/observation-shared (design review D07,
...
export * from "../../../packages/observation-shared/src/identity-contract.ts";
