// Compatibility re-export. shared/evidence-contract.ts moved to packages/observation-shared (design review D07,
...
export * from "../../../packages/observation-shared/src/evidence-contract.ts";
