// Compatibility re-export. shared/api-contract.ts moved to packages/observation-shared (design review D07,
...
export * from "../../../packages/observation-shared/src/api-contract.ts";
