// Compatibility re-export. shared/api-validation.ts moved to packages/observation-shared (design review D07,
...
export * from "../../../packages/observation-shared/src/api-validation.ts";
