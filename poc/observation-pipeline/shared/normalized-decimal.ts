// Compatibility re-export. shared/normalized-decimal.ts moved to packages/observation-shared (design review D07,
...
export * from "../../../packages/observation-shared/src/normalized-decimal.ts";
