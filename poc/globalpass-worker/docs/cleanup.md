...
- Container instance identity `prestia-globalpass-read-only-v10`: A/B終了後に`stop`済み。再検証しないなら管理token必須の`/container-stop?instance=v10&action=destroy`で破棄できる。
...
- 現行Container image `sha256:35d493c8d276d9e6d58856fe4b132d5ec9a14cbc28f92118c48dc5fc50bb9c03`と、registryに残る上記旧image。
