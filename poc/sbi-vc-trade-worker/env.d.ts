/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false env.d.ts` (hash: 9c52387c058fea9973c7564fb82366c1)
...
interface __BaseEnv_Env {
	...
	SESSION_STATE: DurableObjectNamespace<import("./src/worker").SbiVcSessionState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "SbiVcSessionState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COLLECTOR_SCHEMA_VERSION" | "SESSION_SEED" | "SESSION_ENCRYPTION_KEY" | "ADMIN_TOKEN" | "PASSKEY_CREDENTIAL">> {}
}
