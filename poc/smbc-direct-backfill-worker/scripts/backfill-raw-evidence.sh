...
admin_token_file="${1:-${user_home}/.local/share/kogane/secrets/smbc-direct-worker-admin-token}"
collector_url="${SMBC_DIRECT_WORKER_BASE_URL:-https://kogane-smbc-direct-backfill-poc.takuanimal.workers.dev}"
state_dir="${KOGANE_STATE_DIR:-${user_home}/.local/state/kogane}"
cursor_file="${state_dir}/smbc-direct-raw-evidence-backfill.cursor"
