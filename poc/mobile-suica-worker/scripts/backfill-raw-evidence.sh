...
admin_token_file="${1:-${user_home}/.local/share/kogane/secrets/mobile-suica-admin-token}"
collector_url="${MOBILE_SUICA_WORKER_BASE_URL:-https://kogane-mobile-suica-collector-poc.takuanimal.workers.dev}"
state_dir="${KOGANE_STATE_DIR:-${user_home}/.local/state/kogane}"
cursor_file="${state_dir}/mobile-suica-raw-evidence-backfill.cursor"
