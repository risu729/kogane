...
| --- | --- | --- |
| `@cloudflare/puppeteer` | 1.1.0, 1.4.0 | experiments/cloudflare-browser-run: `1.4.0` → 1.4.0<br>poc/globalpass-worker: `1.4.0` → 1.4.0<br>poc/mobile-suica-worker: `1.1.0` → 1.1.0<br>poc/myjcb-worker: `1.4.0` → 1.4.0 |
...
| `@types/node` | 24.3.0, 26.3.0, 26.4.0, 26.4.1 | experiments/cloudflare-browser-run: `26.3.0` → 26.3.0<br>poc/globalpass-worker: `26.4.0` → 26.4.0<br>poc/mobile-suica-worker: `24.3.0` → 24.3.0<br>poc/moneyforward-worker: `24.3.0` → 24.3.0<br>poc/sbi-securities-worker: `24.3.0` → 24.3.0<br>poc/sbi-shinsei-worker: `24.3.0` → 24.3.0<br>poc/sony-bank-worker: `24.3.0` → 24.3.0<br>poc/tamia-tcp-bridge: `26.3.0` → 26.3.0<br>poc/vpoint-pay-worker: `24.3.0` → 24.3.0<br>poc/vpoint-worker: `24.3.0` → 24.3.0<br>services/evidence-browser: `26.4.1` → 26.4.1<br>services/raw-evidence: `26.4.1` → 26.4.1 |
...
| `typescript` | 5.9.3, 7.0.2 | experiments/cloudflare-browser-run: `5.9.3` → 5.9.3<br>experiments/cloudflare-runtime-probe: `5.9.3` → 5.9.3<br>packages/application: `5.9.3` → 5.9.3<br>packages/collection: `5.9.3` → 5.9.3<br>packages/domain: `5.9.3` → 5.9.3<br>packages/evidence-contract: `5.9.3` → 5.9.3<br>packages/identity: `5.9.3` → 5.9.3<br>packages/observation-shared: `5.9.3` → 5.9.3<br>packages/parsers: `5.9.3` → 5.9.3<br>packages/read-model: `5.9.3` → 5.9.3<br>poc/globalpass-worker: `5.9.3` → 5.9.3<br>poc/mobile-suica-worker: `5.9.3` → 5.9.3<br>poc/moneyforward-worker: `5.9.3` → 5.9.3<br>poc/myjcb-worker: `5.9.3` → 5.9.3<br>poc/observation-pipeline: `5.9.3` → 5.9.3<br>poc/sbi-securities-worker: `5.9.3` → 5.9.3<br>poc/sbi-shinsei-worker: `5.9.3` → 5.9.3<br>poc/sbi-vc-trade-client: `5.9.3` → 5.9.3<br>poc/sbi-vc-trade-worker: `5.9.3` → 5.9.3<br>poc/smbc-direct-backfill-worker: `5.9.3` → 5.9.3<br>poc/sony-bank-worker: `5.9.3` → 5.9.3<br>poc/tamia-tcp-bridge: `5.9.3` → 5.9.3<br>poc/vpass-json: `5.9.3` → 5.9.3<br>poc/vpoint-pay-worker: `5.9.3` → 5.9.3<br>poc/vpoint-worker: `5.9.3` → 5.9.3<br>services/collector-r2-importer: `5.9.3` → 5.9.3<br>services/evidence-browser: `7.0.2` → 7.0.2<br>services/observation-pipeline: `5.9.3` → 5.9.3<br>services/raw-evidence: `7.0.2` → 7.0.2 |
| `wrangler` | 4.125.0, 4.126.0, 4.127.0, 4.127.1, 4.128.0 | experiments/cloudflare-browser-run: `4.125.0` → 4.125.0<br>experiments/cloudflare-runtime-probe: `4.125.0` → 4.125.0<br>packages/collection: `4.128.0` → 4.128.0<br>poc/globalpass-worker: `4.127.0` → 4.127.0<br>poc/mobile-suica-worker: `4.127.1` → 4.127.1<br>poc/moneyforward-worker: `4.127.1` → 4.127.1<br>poc/myjcb-worker: `4.127.1` → 4.127.1<br>poc/sbi-securities-worker: `4.126.0` → 4.126.0<br>poc/sbi-shinsei-worker: `4.127.1` → 4.127.1<br>poc/sbi-vc-trade-worker: `4.127.1` → 4.127.1<br>poc/smbc-direct-backfill-worker: `4.127.1` → 4.127.1<br>poc/sony-bank-worker: `4.128.0` → 4.128.0<br>poc/tamia-tcp-bridge: `4.125.0` → 4.125.0<br>poc/vpass-json: `4.126.0` → 4.126.0<br>poc/vpoint-pay-worker: `4.127.1` → 4.127.1<br>poc/vpoint-worker: `4.126.0` → 4.126.0<br>services/collector-r2-importer: `4.128.0` → 4.128.0<br>services/evidence-browser: `4.128.0` → 4.128.0<br>services/observation-pipeline: `4.128.0` → 4.128.0<br>services/raw-evidence: `4.128.0` → 4.128.0 |
...
| `entities` | 6.0.1, 8.1.0 | packages/parsers: 8.1.0<br>poc/myjcb-worker: 8.1.0<br>poc/observation-pipeline: 8.1.0<br>poc/vpoint-worker: 6.0.1<br>services/collector-r2-importer: 8.1.0<br>services/observation-pipeline: 8.1.0 |
| `fsevents` | 2.3.2, 2.3.3 | experiments/cloudflare-browser-run: 2.3.3<br>experiments/cloudflare-runtime-probe: 2.3.3<br>packages/collection: 2.3.3<br>poc/globalpass-worker: 2.3.3<br>poc/globalpass-worker/container: 2.3.2<br>poc/mobile-suica-worker: 2.3.3<br>poc/moneyforward-worker: 2.3.3<br>poc/myjcb-worker: 2.3.3<br>poc/observation-pipeline: 2.3.3<br>poc/oci-browser-probe: 2.3.2<br>poc/sbi-securities-worker: 2.3.3<br>poc/sbi-shinsei-worker: 2.3.3<br>poc/sbi-shinsei-worker/container: 2.3.2<br>poc/sbi-vc-trade-worker: 2.3.3<br>poc/smbc-direct-backfill-worker: 2.3.3<br>poc/sony-bank-worker: 2.3.3<br>poc/tamia-tcp-bridge: 2.3.3<br>poc/vpass-json: 2.3.3<br>poc/vpoint-pay-worker: 2.3.3<br>poc/vpoint-worker: 2.3.3<br>services/collector-r2-importer: 2.3.3<br>services/evidence-browser: 2.3.3<br>services/observation-pipeline: 2.3.3<br>services/raw-evidence: 2.3.3 |
...
| `undici-types` | 7.10.0, 8.3.0 | experiments/cloudflare-browser-run: 8.3.0<br>experiments/cloudflare-runtime-probe: 8.3.0<br>packages/application: 8.3.0<br>packages/collection: 8.3.0<br>packages/domain: 8.3.0<br>packages/evidence-contract: 8.3.0<br>packages/identity: 8.3.0<br>packages/observation-shared: 8.3.0<br>packages/parsers: 8.3.0<br>packages/read-model: 8.3.0<br>poc/globalpass-worker: 8.3.0<br>poc/mobile-suica-worker: 7.10.0<br>poc/moneyforward-worker: 7.10.0<br>poc/myjcb-worker: 8.3.0<br>poc/observation-pipeline: 8.3.0<br>poc/sbi-securities-worker: 7.10.0<br>poc/sbi-shinsei-worker: 7.10.0<br>poc/sbi-vc-trade-client: 8.3.0<br>poc/sbi-vc-trade-worker: 8.3.0<br>poc/smbc-direct-backfill-worker: 8.3.0<br>poc/sony-bank-worker: 7.10.0<br>poc/tamia-tcp-bridge: 8.3.0<br>poc/vpass-json: 8.3.0<br>poc/vpoint-pay-worker: 7.10.0<br>poc/vpoint-worker: 8.3.0<br>services/collector-r2-importer: 8.3.0<br>services/evidence-browser: 8.3.0<br>services/observation-pipeline: 8.3.0<br>services/raw-evidence: 8.3.0 |
